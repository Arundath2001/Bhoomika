    ...
    <div className='propertycard'>
      <div className='propertycard_cont'>
        <div className='propertycard_top'>
          <img className='propertycard_img' src={imageurl} alt={propertyname} />
        ...
        <div className='propertycard_down'>
          ...
          <div className='propertycard_details3'>
            ...
            <p className='propertycard_money'>{budget} Lakhs</p>
          </div>
      ...
      {isDescriptionVisible && (
        <div className='description_popup'>
          ...
          <p className='description_popupdet'>{locationdetails} , {description}</p>
        </div>
      )}
    </div>
  );
