            ...
            {isOpen && (
                <div className="navbar_overlay">
                    ...
                    <div className="navbar_overlaycontact">
                        ...
                        <LinkIcon textColor="greytext" text="info@company.com" svg1={<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256"><path fill="currentColor" d="M128 136a8 8 0 0 1-4.8-1.6l-88-64a8 8 0 1 1 9.6-12.8L128 117.86l83.2-60.26a8 8 0 1 1 9.6 12.8l-88 64a8 8 0 0 1-4.8 1.6Z"/><path fill="currentColor" d="M216 216H40a24.07 24.07 0 0 1-24-24V64a24.07 24.07 0 0 1 24-24h176a24.07 24.07 0 0 1 24 24v128a24.07 24.07 0 0 1-24 24ZM40 56a8 8 0 0 0-8 8v128a8 8 0 0 0 8 8h176a8 8 0 0 0 8-8V64a8 8 0 0 0-8-8Z"/></svg>} />
                    </div>
                </div>
            )}
        </div>
